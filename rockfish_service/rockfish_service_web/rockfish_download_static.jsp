...
<%
	...
	System.out.println("■■■■■■■■■■■■■■■ [ METHOD ] :"+request.getMethod() +" : DOWNLOAD STATIC");
	// HEADER
	...
	try{
		file = new File(realFolder+File.separator+"download.jpg");
		byte b[] = new byte[4096];

		response.reset();
		response.setContentType("application/octet-stream");
		response.setHeader("Content-Disposition", "attatchment; filename=download.jpg");
